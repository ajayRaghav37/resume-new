          ...
          <div className="project-details">
            <div className="project-header">
              ...
              <div>
                ...
                <p className="skills very-small-text">NODE.JS | REACT.JS | MONGODB |
                  PYTHON | GITLAB | OPENSHIFT | AZURE | KEYCLOAK | ANGULAR</p>
              </div>
            </div>
            <div className="project-summary">
      ...
      <div className="projects">
        ...
        <div className="project">
          <div className="project-details">
            ...
            <div className="project-summary">
              <p className="project-summary-intro">Developed a solution to reverse engineer invoices
                of billions of bookings
                across various countries to ensure compliance. Accuracy and
                performance SLAs were 98% and 150ms/booking. Results were 99.2% and 10ms/booking
                respectively.</p>
            </div>
          </div>
        </div>
