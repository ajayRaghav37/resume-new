          ...
          <div className="project-details">
            ...
            <div className="project-summary">
              <p className="project-summary-intro">Integrated different assets created in AI/ML stream into one SaaS
                product. Alive Intelligence can power an AI-enabled enterprise grade contact center ecosystem
                through its powerful virtual assistant. Alive Intelligence is a combination of Masterbot,
                Botify.kit, Smart
                Search, Ticket Prediction, Ontofy, Live Chat and Automatic Test.
                With more than <b>5 million users</b>, it has won over <b>10 millon Euros</b> for Sopra Steria.
              </p>
              <p className="roles-responsibilities-title">My roles and responsibilities:</p>
