          ...
          <div className="project-details">
            ...
            <div className="project-summary">
              ...
              <ul className="roles-responsibilities">
                ...
                <li>Creating rooms and using WebSockets to make the message transfers almost instantaneous.</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="project">
          <div className="project-details">
            ...
            <div className="project-summary">
              ...
              <p className="roles-responsibilities-title">My roles and responsibilities:</p>
              <ul className="roles-responsibilities">
                <li>Leading a team of 12 developers.</li>
                <li>Conceptualizing and architecting the application in a way that it could support multitenancy.
                </li>
                <li>Implementing adaptor pattern for handling different platforms.</li>
                <li>Designing database, collections and setting indexing rules.</li>
                <li>Creating contributor guidelines for Node.js and React.js for the entire team of 100+
                  developers.
                </li>
                <li>Creating UI mock-ups for complex components and implementing those components.</li>
                <li>Creating a template in Next.js for new assets with built-in features like auth, i18n,
